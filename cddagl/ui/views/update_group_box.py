...
import arrow
from PyQt5.QtCore import Qt, QTimer, QUrl, QFileInfo, pyqtSignal,QThread
from PyQt5.QtNetwork import QNetworkAccessManager, QNetworkRequest
from PyQt5.QtWidgets import (
    QApplication, QGridLayout, QGroupBox, QLabel,
    QPushButton, QToolButton, QProgressBar, QButtonGroup, QRadioButton,
    QComboBox, QTextBrowser, QMessageBox, QStyle, QHBoxLayout
)
from babel.dates import format_datetime

from cddagl.system import move_path, delete_path

import cddagl.constants as cons
from cddagl.constants import get_cddagl_path
from cddagl import __version__ as version
from cddagl.functions import (
    tryint, is_64_windows, sizeof_fmt, unique, log_exception
)

from cddagl.system import find_process_with_file_handle
...
class UpdateGroupBox(QGroupBox):
    ...
    def download_http_finished(self):
        ...
        if self.download_aborted:
            ...
            test_thread = self.test_download_thread(self.downloaded_file)
    ...
    def test_download_thread(self, downloaded_file):
        class TestingWinZipThread(QThread):
            ...
            def __init__(self, downloaded_file):
                super(TestingWinZipThread, self).__init__()
            ...
            def run(self):
                # TODO: Extend this test, it might be a bit naive
